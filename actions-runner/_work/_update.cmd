...
set rootfolder=D:\Blog\blog\actions-runner
set existrunnerversion=2.306.0
set downloadrunnerversion=2.307.1
set logfile=D:\Blog\blog\actions-runner\_diag\SelfUpdate-20230731-013504.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "D:\Blog\blog\actions-runner\run.cmd"
) else (
  endlocal
)
